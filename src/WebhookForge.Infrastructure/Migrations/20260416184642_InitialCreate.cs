        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkspaceMembers_Users",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkspaceMembers_Workspaces",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncomingRequests_Endpoints",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchMethod = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    MatchPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MatchBodyExpression = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ResponseStatus = table.Column<short>(type: "smallint", nullable: false, defaultValue: (short)200),
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Endpoints_Token",
                table: "Endpoints",
                column: "Token",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_IncomingRequests_EndpointId_ReceivedAt",
                table: "IncomingRequests",
                columns: new[] { "EndpointId", "ReceivedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_MockRules_EndpointId_Priority",
                table: "MockRules",
                columns: new[] { "EndpointId", "Priority", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "UX_WorkspaceMembers_WorkspaceUser",
                table: "WorkspaceMembers",
